...
\begin{figure}[htbp]
    \centering
    \resizebox{0.85\textwidth}{!}{\input{imagenes/auth_rbac.tikz}}
...
\footnotesize
\begin{tabular}{|>{\raggedright\arraybackslash}p{2.2cm}|>{\raggedright\arraybackslash}p{2.5cm}|>{\raggedright\arraybackslash}p{2.6cm}|>{\raggedright\arraybackslash}p{5.0cm}|}
\hline
