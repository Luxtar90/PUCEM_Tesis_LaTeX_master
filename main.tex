...
\else
  ...
  \begin{tabular}{@{}p{3.4cm}p{10.0cm}r@{}}
    ...
    \midrule
    \hyperref[ap:A]{Apéndice A} & Detalle de relaciones críticas del modelo de datos & \pageref{ap:A}\\
    \hyperref[ap:B]{Apéndice B} & Diagrama de red del sistema & \pageref{ap:B}\\
    \hyperref[ap:C]{Apéndice C} & Procedimiento detallado de validación en \textit{staging} & \pageref{ap:C}\\
    \hyperref[ap:D]{Apéndice D} & Síntesis de la guía de entrevista semiestructurada & \pageref{ap:D}\\
    \hyperref[ap:E]{Apéndice E} & Arquitectura detallada de la plataforma & \pageref{ap:E}\\
  \end{tabular}
\fi
